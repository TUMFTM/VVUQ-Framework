function PlotHandle = Plot_SystemVVUQResultsExport_Calculated_Measurement_Confidence(obj,iResult,resolution,xlimwidth,width,height,margin)
...
% ------------
 ...
 %       PlotHandle.InputUCMonteCarloCDFs=Plot_InputUCMoneCarloCDFs(obj.InputPropagationUC,iResult,resolution);
        ...
        title(['Predicted VVUQ of ',strrep(obj.SystemConf.Name,'_','\_'),', CDF Plot of ',obj.InputPropagationUC.MonteCarloDoE.Properties.VariableNames{1,ResultCollNum}],'FontSize',11,'Interpreter','latex');
        ...
        switch class(obj.InputPropagationUC.MonteCarloDoE{1,ResultCollNum}{1, 1}{1,1})
            ...
            case 'double' 
                ...
                max(PlotHandle.MeasurementCDF.XData);
%                 line([max(PlotHandle.MeasurementCDF.XData) max(PlotHandle.MeasurementCDF.XData)*1000+10000],[1 1],'Color',PlotHandle.MeasurementCDF.Color,'LineStyle','-','LineWidth',PlotHandle.MeasurementCDF.LineWidth);
%                 line([min(PlotHandle.MeasurementCDF.XData)/10000-10000 min(PlotHandle.MeasurementCDF.XData)],[0 0],'Color',PlotHandle.MeasurementCDF.Color,'LineStyle','-','LineWidth',PlotHandle.MeasurementCDF.LineWidth);
                ...
                PlotHandle.Legend=legend([PlotHandle.InputUCPBox PlotHandle.ModelFormUC(1) PlotHandle.NumericUC(1) PlotHandle.MeasurementCDF],{'Model Input UC', 'Model Form UC', 'Numerical UC','Measurement'},...
                    'Position',[0.119603436618642,0.761056567529813,0.369625830305223,0.19118942479205], 'Interpreter', 'latex','FontSize',8);
